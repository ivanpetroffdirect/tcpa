document.addEventListener('DOMContentLoaded', () => {
  const helpData = {
    ...
    margin: {
      title: "Маржа",
      text: "Грязная прибыль с одного проданного товара без учета маркетинга.",
      formula: "Маржа = Средний чек - Себестоимость - Издержки"
    },
    drr: {
      title: "Желаемый % расхода от маржи",
      text: "Какую долю от своей чистой маржи вы готовы максимально инвестировать в привлечение одного покупателя. Если не знаете, что указать, оставьте значение по умолчанию 40%.",
      formula: "Заданное пользователем значение"
    },
    buyout: {
    ...
    'tcpa-no-vat': {
      ...
      text: "Именно это значение нужно указывать в поле «Целевая цена за конверсию» в настройках Яндекс Директа, так как баланс внутри рекламного кабинета отображается «чистым» (без НДС).",
